  ...
  return (
    <main style={{ minHeight: '100vh', padding: '48px 24px 80px', maxWidth: 680, margin: '0 auto' }}>
      ...
      <div style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.65)', lineHeight: 1.85 }}>
        ...
        <p style={{ marginBottom: 24 }}>Founded by <strong style={{ color: '#ffffff' }}>Sami Samii</strong>, S2D Capital Insights is built for investors, analysts, and decision-makers who need a unified view of global markets.</p>
