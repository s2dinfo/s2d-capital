    ...
    <div style={{padding:'28px 48px 48px',minHeight:'80vh',overflowX:'hidden'}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:14,marginBottom:28}}>
        <div style={{background:'var(--bg-warm)',border:'1px solid var(--border-lt)',padding:'28px 24px',borderLeft:'4px solid #8B5E3C'}}>
          ...
          <div style={{fontFamily:'var(--font-mono)',fontSize:'2.6rem',fontWeight:700,color:'#fff',lineHeight:1}}>${commod.oil?.toFixed(2)||'-'}<span style={{fontSize:'0.8rem',color:'var(--text-muted)',fontWeight:400,marginLeft:6}}>/barrel</span></div>
        </div>
        <div style={{background:'var(--bg-warm)',border:'1px solid var(--border-lt)',padding:'28px 24px',borderLeft:'4px solid #B8860B'}}>
          ...
          <div style={{fontFamily:'var(--font-mono)',fontSize:'2.6rem',fontWeight:700,color:'#fff',lineHeight:1}}>${commod.gold?.toFixed(0)||'-'}<span style={{fontSize:'0.8rem',color:'var(--text-muted)',fontWeight:400,marginLeft:6}}>/oz</span></div>
