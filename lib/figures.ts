...
// `model` = the REAL 3D character (Meshy image-to-3D of the portrait) that stands in the
// world — replaces the old flat hologram billboard. Generated by scripts/gen-from-image.mjs.
export const FIGURES: Record<string, { image: string; accent: string; env?: string; model?: string }> = {
  Nvidia: { image: '/characters/jensen-figure.png', accent: '#1affa0', env: 'datacenter', model: '/models/figures/jensen.glb' }, // nvidia green
  TSMC: { image: '/characters/cc-wei-figure.png', accent: '#3aa0ff', env: 'cleanroom', model: '/models/figures/cc-wei.glb' },   // silicon blue
  ASML: { image: '/characters/fouquet-figure.png', accent: '#ff9a3a', env: 'euvhall', model: '/models/figures/fouquet.glb' },  // lithography amber
  Copper: { image: '/characters/andres-figure.png', accent: '#e8843a', env: 'minepit', model: '/models/figures/andres.glb' }, // copper
  Power: { image: '/characters/nadia-figure.png', accent: '#ffd23a', env: 'controlroom', model: '/models/figures/nadia.glb' },   // grid yellow
  OpenAI: { image: '/characters/altman-figure.png', accent: '#9d8bff', env: 'datacenter', model: '/models/figures/altman.glb' },  // AI violet — the demand
  Microsoft: { image: '/characters/nadella-figure.png', accent: '#2bc4c4', env: 'controlroom', model: '/models/figures/nadella.glb' }, // cloud teal — the capital
  Oil: { image: '/characters/nasser-figure.png', accent: '#d4a23a', env: 'refinery', model: '/models/figures/nasser.glb' },        // oil amber — the old power
  RareEarth: { image: '/characters/rareearth-figure.png', accent: '#e0483a', env: 'minepit', model: '/models/figures/rareearth.glb' }, // china red — the chokepoint
};
